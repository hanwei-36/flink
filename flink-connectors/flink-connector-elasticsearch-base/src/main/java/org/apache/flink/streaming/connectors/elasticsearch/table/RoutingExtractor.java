...
class RoutingExtractor implements Function<RowData, String>, Serializable {
    ...
    private RoutingExtractor(FieldFormatter[] fieldFormatters, String keyDelimiter) {
    ...
    public static Function<RowData, String> createRoutingExtractor(
            TableSchema schema, List<String> columns, String delimiter) {
        if (columns == null || columns.size() == 0) {
            ...
            return new RoutingExtractor(fieldFormatters, delimiter);
        }
    }
