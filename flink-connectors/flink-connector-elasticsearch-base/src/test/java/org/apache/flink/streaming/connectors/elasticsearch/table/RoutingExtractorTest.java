...
public class RoutingExtractorTest {
    @Test
    public void testSimpleKey() {
        ...
        Function<RowData, String> extractor =
                RoutingExtractor.createRoutingExtractor(schema, columns, "_");

        String key = extractor.apply(GenericRowData.of(12L, StringData.fromString("ABCD")));
